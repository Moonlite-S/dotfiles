...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="noctalia"
...
# claude_code.sh {
	...
	# export TMUX_POWERLINE_SEG_CLAUDE_CODE_CREDENTIALS_FILE="/home/shawnlings/.claude/.credentials.json"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/shawnlings/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/shawnlings/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/shawnlings/.now_playing.log"
...
# tmux_continuum_save.sh {
	...
	export TMUX_POWERLINE_SEG_TMUX_CONTINUUM_PATH="/home/shawnlings/.config/tmux/plugins//tmux-continuum"
# }
...
# weather.sh {
	...
	#   rm "/tmp/tmux-powerline_shawnlings/tmux-powerline/weather_cache_data.txt"
